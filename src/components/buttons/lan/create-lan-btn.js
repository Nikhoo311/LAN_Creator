...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        modal.addComponents([new ActionRowBuilder().addComponents(textInputLabel), new ActionRowBuilder().addComponents(textGoogleSheetLabel), new ActionRowBuilder().addComponents(textNbVocLabel)])

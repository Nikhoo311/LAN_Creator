...
module.exports = {
    ...
    async execute(client) {     
        try {
            ...
            lans.map(lan => client.lans.set(lan._id, new Lan(lan.name, lan.channels, lan.config, lan.paricipants, lan._id, Math.floor(lan.startedAt / 1000), Math.floor(lan.endedAt / 1000))))
